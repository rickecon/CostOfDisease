...
% to skip line between paragraphs and not indent
\usepackage[parfill]{parskip}

% for midline decimals
\usepackage{siunitx}
\sisetup{
...
\ \\
\emph{Interpretation:}
The findings shed light on the economic costs of disease and the fragility of health systems that are highly dependent on external financing. The results highlight the importance of continued investment in public health, particularly in low- and middle-income countries, to prevent the resurgence of contagious diseases and their associated economic costs.
