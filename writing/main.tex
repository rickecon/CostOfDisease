...
\textcolor{magenta}{[Add some description that points to the results in the next section.]}
...
\textcolor{magenta}{[Put section here with results on South Africa replacing the US spending cuts with its own increased spending.]}
